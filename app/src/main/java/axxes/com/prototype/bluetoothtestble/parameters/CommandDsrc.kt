...
import axxes.com.prototype.bluetoothtestble.model.v1.Request
import axxes.com.prototype.bluetoothtestble.model.v1.Response
 ...
 */
enum class CommandDsrc(val value: Int, val category: CategoryDsrc, val request: Request, val response: Response, val description: String) {
    /**
